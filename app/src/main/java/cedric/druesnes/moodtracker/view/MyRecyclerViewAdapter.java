...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder> {
    ...
    private void setDateText(int position, ViewHolder holder) {
        MoodModel moodModel = mData.get(position);
        if (moodModel.getDate() != null) {
            int differenceInDays = (int) TimeUnit.DAYS.convert(new Date().getTime() - moodModel.getDate().getTime(), TimeUnit.MILLISECONDS);
